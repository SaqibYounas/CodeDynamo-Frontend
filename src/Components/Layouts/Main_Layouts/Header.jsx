    ...
    <header className="bg-gradient-to-r from-white via-blue-50 to-white shadow-md sticky top-0 z-50">
      <div className="container mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2 md:hidden">
          <Link
            to="/auth/login"
            className="px-3 py-1 text-sm border border-blue-600 text-blue-600 rounded-md hover:bg-blue-600 hover:text-white transition shadow-sm"
          >
            Login
          </Link>
          <Link
        ...
        <div className="hidden md:flex space-x-2">
          <Link
            to="/auth/login"
            className="px-4 py-2 border border-blue-600 text-blue-600 rounded-md hover:bg-blue-600 hover:text-white transition shadow-sm"
          >
            Login
          </Link>
          <Link
