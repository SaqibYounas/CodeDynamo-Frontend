...
function MyInvoices() {
  ...
  return (
    <div className="p-4 lg:pl-64 md:pl-80 bg-gray-100 min-h-screen">
      <h1 className="text-3xl font-bold text-gray-800 mb-6">🧾 My Invoices</h1>

      <div className="overflow-x-auto bg-white rounded shadow sm:text-sm">
        <table className="min-w-full text-left border">
          <thead className="bg-gray-100 text-gray-700">
            <tr>
              ...
              <th className="py-3 px-4 border-b">PDF</th>
            </tr>
          </thead>
          <tbody>
            {loading ? (
