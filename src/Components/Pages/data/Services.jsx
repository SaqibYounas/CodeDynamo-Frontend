...
export const staticServices = [
  {
    icon: <FaLaptopCode className="text-4xl text-[#57007B]" />,
    title: "Web Development",
    description:
      "A Website is an extension of yourself and we can help you to express it properly. Your website is your number one marketing asset because we live in a digital age.",
  },
  {
    icon: <FaMobileAlt className="text-4xl text-[#57007B]" />,
    title: "Mobile Apps",
    description:
  ...
  {
    icon: <FaPaintBrush className="text-4xl text-[#57007B]" />,
    title: "UI/UX Design",
    description:
  ...
  {
    icon: <FaBug className="text-4xl text-[#57007B]" />,
    title: "QA & Testing",
    description:
  ...
  {
    icon: <FaCloud className="text-4xl text-[#57007B]" />,
  ...
  {
    icon: <FaRobot className="text-4xl text-[#57007B]" />,
